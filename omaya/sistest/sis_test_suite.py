from omaya.labjack_t7.labjackt7 import LabJackT7
import time
import pandas as pd
import numpy
import os
...
from omaya.sistest.sweep_test import get_swept_IF, Vsense, Isense, sweep_IF, \
...
class SISTestSuite(object):
    ...
    def PIV_Curves(self, channel=0, device='3',
        ...
        axIV.legend()
        axIV.grid()
        axIV.set_title('{:s} 2021 SIS{:s} {:.0f}GHz'.format(self.directory, device, lofreq))
        #figIV.show()
        plt.draw()
        plt.show()
        plt.pause(0.001)
